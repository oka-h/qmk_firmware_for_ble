...
#define IS_BLE_ON      IS_LAYER_ON(_BLE)
#define IS_BLE_OFF     IS_LAYER_OFF(_BLE)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT( \
        ...
        _______, NUMERIC, XXXXXXX, XXXXXXX, XXXXXXX, BLE,                       XXXXXXX, XXXXXXX, KC_COMM, KC_DOT,  HLD_LOW, XXXXXXX, \
                                            _______, _______, _______, _______, _______, _______ \
    ),
     ...
     * |------+------+------+------+------+------|                |------+------+------+------+------+------|
     * | Ctrl | App  |      |      |      |Reset |                |      |JIS_TG|      |OS_TGL|Insert|RAISE |
     * |------+------+------+------+------+------|                |------+------+------+------+------+------|
     * |Shift |ZHTGTG|      |      |LAYOTG|      |                |NumLc |RMODTG| PtSc | ScLc |Pause |      |
     * `---------------------------+------+------+------.  ,------+------+------+---------------------------'
     *                             | Alt  |Space |LOWER |  | Bksp |Enter | GUI  |
     *                             `--------------------'  `--------------------'
     */

    [_EXTRA] = LAYOUT( \
        KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                     KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  \
        _______, KC_APP,  XXXXXXX, XXXXXXX, XXXXXXX, RESET,                     XXXXXXX, JIS_TG,  XXXXXXX, OS_TG,   KC_INS,  _______, \
    ...
    [_BLE] = LAYOUT( \
        BLE_EN,  AD_WO_L, XXXXXXX, XXXXXXX, XXXXXXX, USB_EN,                    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
        ADV_ID0, ADV_ID1, ADV_ID2, ADV_ID3, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
        DEL_ID0, DEL_ID1, DEL_ID2, DEL_ID3, DELBNDS, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
                                            XXXXXXX, XXXXXXX, BLE,     XXXXXXX, XXXXXXX, XXXXXXX \
    )
};
